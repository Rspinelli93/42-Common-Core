/*
cc ../other/test.c -Wall -Wextra -Werror -I . -L . -l ft -o test
...
int main(void)
{
    ...
    char *dest11 = strchr(src11, 't' + 256);
    printf("%s\n", dest11) ;

    char *src12 = "s";
    char *dest12 = ft_strchr(src12, 't' + 256);
    printf("%s\n", dest12) ;
    printf("--------- STRCHR ---------\n\n");
	...
	printf("%s\n", ft_strnstr("lorem ipsum dolor sit amet", "amet", 5));
	printf("%s\n", ft_strnstr("lorem ipsum dolor sit amet", "ipsum", 30));
	printf("%s\n", ft_strnstr("lorem ipsum dolor sit amet", "asd", 30));
	...
	char	*cont1 = "hola";
	char	*cont2 = "good job";
	t_list	*list1 = ft_lstnew(cont1);
	t_list	*list2 = ft_lstnew(cont2);
	printf("%s\n%s\n", (char *)list1->content, (char *)list2->content);
	printf("--------- FT_LSTNEW ---------\n\n");

	printf("--------- FT_LSTADDFRONT ---------\n");
	char	*cont3 = "first";
	ft_lstadd_front(&list2, ft_lstnew(cont3));
	for(int i = 0; i < 2; i++)
	{
		printf("%s\n", (char *)list2->content);
		list2 = list2->next;
	...
	char	*cont4 = "last";
	ft_lstadd_back(&list1, ft_lstnew(cont4));
	for(int i = 0; i < 2; i++)
	{
		printf("%s\n", (char *)list1->content);
		list1 = list1->next;
